<template>
  <div class="border-2 rounded-lg m-2 p-2">
    <div v-if="!showBundles" class="cursor-pointer" @click="showBundles = true">
      Show bundles
    </div>
    <div v-else>
      <div>
        <div class="w-full flex flex-row mb-6 justify-between">
          <div @click="showBundles = false" class="cursor-pointer">
            Hide Bundles
          </div>
          <a
              ...
              <div class="relative z-0 mb-6 w-full group">
                <div class="flex flex-row justify-around">
                  <div
                    ...
                    v-if="dirty.includes(bundle.guid)"
                  >
                    Save
                  </div>
                  <div
                    class="cursor-pointer"
                    @click="deleteBundle(bundle.guid)"
                  >
                    Delete
                  </div>
                  <div
                    class="cursor-pointer"
                    @click="toggleCredits(bundle.guid)"
                  >
                    Details
                  </div>
                </div>
...
export default defineComponent({
  ...
  methods: {
    toggleCredits(guid) {
      if (this.showCredits === guid) {
        this.showCredits = ''
      } else {
        this.showCredits = guid
      }
    },
    makeDirty(guid) {
